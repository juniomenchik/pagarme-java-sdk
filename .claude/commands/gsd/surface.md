...
<objective>
Manage the runtime skill surface without reinstall. Reads/writes `C:/git/digital-menu/pagarme-java-sdk/.claude/skills/.gsd-surface.json`
...
```bash
# Claude Code
RUNTIME_CONFIG_DIR=C:/git/digital-menu/pagarme-java-sdk/.claude/skills

# Resolve commandsDir and agentsDir
COMMANDS_DIR=C:/git/digital-menu/pagarme-java-sdk/.claude/commands/gsd
AGENTS_DIR=C:/git/digital-menu/pagarme-java-sdk/.claude/agents
```
...
<execution_context>
Surface state file: `C:/git/digital-menu/pagarme-java-sdk/.claude/skills/.gsd-surface.json`
Install profile marker: `C:/git/digital-menu/pagarme-java-sdk/.claude/skills/.gsd-profile`
Engine module: `C:/git/digital-menu/pagarme-java-sdk/.claude/get-shit-done/bin/lib/surface.cjs`
Cluster definitions: `C:/git/digital-menu/pagarme-java-sdk/.claude/get-shit-done/bin/lib/clusters.cjs`
</execution_context>
