...
- @C:/git/digital-menu/pagarme-java-sdk/.claude/get-shit-done/workflows/complete-milestone.md (main workflow)
- @C:/git/digital-menu/pagarme-java-sdk/.claude/get-shit-done/templates/milestone-archive.md (archive template)
  </execution_context>
