...
```markdown
Read C:/git/digital-menu/pagarme-java-sdk/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: C:/git/digital-menu/pagarme-java-sdk/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read C:/git/digital-menu/pagarme-java-sdk/.claude/agents/gsd-ui-checker.md for instructions.
