...
<template>
@C:/git/digital-menu/pagarme-java-sdk/.claude/get-shit-done/templates/UAT.md
</template>
...
**MVP-mode UAT framing.** When `MVP_MODE=true`, follow the rules in `@C:/git/digital-menu/pagarme-java-sdk/.claude/get-shit-done/references/verify-mvp-mode.md`. Briefly:
...
Read and follow `C:/git/digital-menu/pagarme-java-sdk/.claude/get-shit-done/workflows/transition.md`.
...
- Follow @C:/git/digital-menu/pagarme-java-sdk/.claude/get-shit-done/workflows/diagnose-issues.md
