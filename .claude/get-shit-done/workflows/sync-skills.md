...
INSTALL_JS_GLOBAL="C:/git/digital-menu/pagarme-java-sdk/.claude/get-shit-done/bin/install.js"
...
error: source skills root not found: <path>
       ...
       Run: node C:/git/digital-menu/pagarme-java-sdk/.claude/get-shit-done/bin/install.js --global --<runtime>
```
Then exit.
