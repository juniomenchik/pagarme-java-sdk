...
- **Global scope**: `C:/git/digital-menu/pagarme-java-sdk/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `C:/git/digital-menu/pagarme-java-sdk/.claude/notes/`)
...
2. Glob `C:/git/digital-menu/pagarme-java-sdk/.claude/notes/*.md` (if directory exists) — global notes
...
Global (C:/git/digital-menu/pagarme-java-sdk/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `C:/git/digital-menu/pagarme-java-sdk/.claude/notes/` — works in any directory
