...
```bash
INIT=$(node "C:/git/digital-menu/pagarme-java-sdk/.claude/get-shit-done/bin/gsd-tools.cjs" init ingest-docs)
...
```bash
node "C:/git/digital-menu/pagarme-java-sdk/.claude/get-shit-done/bin/gsd-tools.cjs" commit \
