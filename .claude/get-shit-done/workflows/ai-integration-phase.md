...
<required_reading>
@C:/git/digital-menu/pagarme-java-sdk/.claude/get-shit-done/references/ai-frameworks.md
@C:/git/digital-menu/pagarme-java-sdk/.claude/get-shit-done/references/ai-evals.md
</required_reading>
...
```markdown
Read C:/git/digital-menu/pagarme-java-sdk/.claude/agents/gsd-framework-selector.md for instructions.
...
Copy template:
```bash
cp "C:/git/digital-menu/pagarme-java-sdk/.claude/get-shit-done/templates/AI-SPEC.md" "${PHASE_DIR}/${PADDED_PHASE}-AI-SPEC.md"
```
...
```markdown
Read C:/git/digital-menu/pagarme-java-sdk/.claude/agents/gsd-ai-researcher.md for instructions.
...
```markdown
Read C:/git/digital-menu/pagarme-java-sdk/.claude/agents/gsd-domain-researcher.md for instructions.
...
```markdown
Read C:/git/digital-menu/pagarme-java-sdk/.claude/agents/gsd-eval-planner.md for instructions.
