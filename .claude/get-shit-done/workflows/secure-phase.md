...
```
Agent(
  prompt="Read C:/git/digital-menu/pagarme-java-sdk/.claude/agents/gsd-security-auditor.md for instructions.\n\n" +
...
**State B (create):**
1. Read template from `C:/git/digital-menu/pagarme-java-sdk/.claude/get-shit-done/templates/SECURITY.md`
