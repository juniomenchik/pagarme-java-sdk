...
```bash
INIT=$(node "C:/git/digital-menu/pagarme-java-sdk/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @C:/git/digital-menu/pagarme-java-sdk/.claude/get-shit-done/templates/spec.md.
