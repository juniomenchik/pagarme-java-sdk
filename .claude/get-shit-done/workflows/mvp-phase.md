...
<required_reading>
@C:/git/digital-menu/pagarme-java-sdk/.claude/get-shit-done/references/user-story-template.md
@C:/git/digital-menu/pagarme-java-sdk/.claude/get-shit-done/references/spidr-splitting.md
@C:/git/digital-menu/pagarme-java-sdk/.claude/get-shit-done/references/planner-mvp-mode.md
</required_reading>
...
Normalize per `@C:/git/digital-menu/pagarme-java-sdk/.claude/get-shit-done/references/phase-argument-parsing.md` (zero-pad integer phases to two digits).
...
Run three sequential `AskUserQuestion` calls. Each is free-text. After all three, assemble into the canonical sentence per `@C:/git/digital-menu/pagarme-java-sdk/.claude/get-shit-done/references/user-story-template.md`:
...
Run the SPIDR rules from `@C:/git/digital-menu/pagarme-java-sdk/.claude/get-shit-done/references/spidr-splitting.md`. Briefly:
