...
Key references:
- @C:/git/digital-menu/pagarme-java-sdk/.claude/get-shit-done/references/ui-brand.md (display patterns)
- @C:/git/digital-menu/pagarme-java-sdk/.claude/agents/gsd-user-profiler.md (profiler agent definition)
- @C:/git/digital-menu/pagarme-java-sdk/.claude/get-shit-done/references/user-profiling.md (profiling reference doc)
</required_reading>
...
```bash
PROFILE_PATH="C:/git/digital-menu/pagarme-java-sdk/.claude/get-shit-done/USER-PROFILE.md"
...
```bash
cp "C:/git/digital-menu/pagarme-java-sdk/.claude/get-shit-done/USER-PROFILE.md" "C:/git/digital-menu/pagarme-java-sdk/.claude/USER-PROFILE.backup.md"
```
...
✓ Stores profile at C:/git/digital-menu/pagarme-java-sdk/.claude/get-shit-done/USER-PROFILE.md
...
- The user-profiling reference doc at `C:/git/digital-menu/pagarme-java-sdk/.claude/get-shit-done/references/user-profiling.md`
...
Reference: @C:/git/digital-menu/pagarme-java-sdk/.claude/get-shit-done/references/user-profiling.md
...
Display: "✓ Profile written to C:/git/digital-menu/pagarme-java-sdk/.claude/get-shit-done/USER-PROFILE.md"
...
- options (ALL pre-selected by default):
  ...
  - "Global CLAUDE.md" -- "Add profile to C:/git/digital-menu/pagarme-java-sdk/.claude/CLAUDE.md for all projects"

**If no artifacts selected:** Display "No artifacts generated. Your profile is saved at C:/git/digital-menu/pagarme-java-sdk/.claude/get-shit-done/USER-PROFILE.md" and jump to step 10.
...
Display: "✓ Generated /gsd-dev-preferences at C:/git/digital-menu/pagarme-java-sdk/.claude/skills/gsd-dev-preferences/SKILL.md"
...
Display: "✓ Added profile section to C:/git/digital-menu/pagarme-java-sdk/.claude/CLAUDE.md"
...
```bash
BACKUP_PATH="C:/git/digital-menu/pagarme-java-sdk/.claude/USER-PROFILE.backup.md"
```
...
Your profile:    C:/git/digital-menu/pagarme-java-sdk/.claude/get-shit-done/USER-PROFILE.md
```

Then list paths for each generated artifact:
```
Artifacts:
  ✓ /gsd-dev-preferences   C:/git/digital-menu/pagarme-java-sdk/.claude/skills/gsd-dev-preferences/SKILL.md
  ✓ CLAUDE.md section       ./CLAUDE.md
  ✓ Global CLAUDE.md        C:/git/digital-menu/pagarme-java-sdk/.claude/CLAUDE.md
```
