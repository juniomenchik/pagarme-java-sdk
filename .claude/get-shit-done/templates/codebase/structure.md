...
- Usage: Reference from command with `@C:/git/digital-menu/pagarme-java-sdk/.claude/get-shit-done/workflows/{name}.md`
...
**get-shit-done/**
- Purpose: Resources installed to C:/git/digital-menu/pagarme-java-sdk/.claude/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)

**commands/**
- Purpose: Slash commands installed to C:/git/digital-menu/pagarme-java-sdk/.claude/commands/
- Source: Copied by bin/install.js during installation
- Committed: Yes (source of truth)
