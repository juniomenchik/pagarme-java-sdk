...
<required_reading>
@C:/git/digital-menu/pagarme-java-sdk/.claude/get-shit-done/references/common-bug-patterns.md
</required_reading>
...
@C:/git/digital-menu/pagarme-java-sdk/.claude/get-shit-done/references/debugger-philosophy.md
...
Check code says:  hooksDir = path.join(configDir, 'hooks')
                  configDir = C:/git/digital-menu/pagarme-java-sdk/.claude
                  → checks C:/git/digital-menu/pagarme-java-sdk/.claude/hooks/

Installer says:   hooksDest = path.join(targetDir, 'hooks')
                  targetDir = C:/git/digital-menu/pagarme-java-sdk/.claude/get-shit-done
                  → writes to C:/git/digital-menu/pagarme-java-sdk/.claude/get-shit-done/hooks/
...
@C:/git/digital-menu/pagarme-java-sdk/.claude/get-shit-done/references/thinking-models-debug.md
...
- Read @C:/git/digital-menu/pagarme-java-sdk/.claude/get-shit-done/references/common-bug-patterns.md
