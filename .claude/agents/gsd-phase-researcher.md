...
@C:/git/digital-menu/pagarme-java-sdk/.claude/get-shit-done/references/thinking-models-research.md
...
```bash
node "C:/git/digital-menu/pagarme-java-sdk/.claude/get-shit-done/bin/gsd-tools.cjs" graphify query "<capability-keyword>" --budget 1500
```
