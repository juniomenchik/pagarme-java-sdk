...
Reference full template: `C:/git/digital-menu/pagarme-java-sdk/.claude/get-shit-done/templates/roadmap.md`

## STATE.md Structure

Use template from `C:/git/digital-menu/pagarme-java-sdk/.claude/get-shit-done/templates/state.md`.
