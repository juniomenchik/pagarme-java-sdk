...
<reference>
@C:/git/digital-menu/pagarme-java-sdk/.claude/get-shit-done/references/user-profiling.md
...
Read the user-profiling reference document at `C:/git/digital-menu/pagarme-java-sdk/.claude/get-shit-done/references/user-profiling.md` to load:
