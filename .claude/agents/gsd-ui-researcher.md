...
Use template from `C:/git/digital-menu/pagarme-java-sdk/.claude/get-shit-done/templates/UI-SPEC.md`.
...
Read template: `C:/git/digital-menu/pagarme-java-sdk/.claude/get-shit-done/templates/UI-SPEC.md`
