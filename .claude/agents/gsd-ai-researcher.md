...
<required_reading>
Read `C:/git/digital-menu/pagarme-java-sdk/.claude/get-shit-done/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
